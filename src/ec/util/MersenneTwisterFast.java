 ...
 * <p><b>Version 4</b>, based on version MT199937(99/10/29)
...
/*
	  ...
	  r.setSeedOld(4357)
	  System.out.println("Output of MersenneTwisterFast, old style");
	  for (j=0;j<1000;j++)
	  {
...
/*
	  r = new MersenneTwisterFast(4357);
  	  System.out.println("Output of MersenneTwisterFast with new (1999/10/28) seeding mechanism");
	  for (j=0;j<1000;j++)
	  {
	  // first, convert the int from signed to "unsigned"
	  long l = (long)r.nextInt();
