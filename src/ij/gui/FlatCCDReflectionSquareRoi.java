...
//    int maxGray = 256;
    ...
    if (usableRectangle != null) {
      ...
      minY = (int) (usableRectangle.getMinY());
      maxY = (int) (usableRectangle.getMaxY());
//	    System.out.println("Using rectangle: " + minX + " " + maxX + " " + minY + " " + maxY);
    } else if (usableRoi != null) {
...
//	    System.out.println("Using roi: " + minX + " " + maxX + " " + minY + " " + maxY);
	    ...
	    System.out.println("Not defined: " + minX + " " + maxX + " " + minY + " " + maxY);
    }*/
...
//    System.out.println("Center " + centerX + " " + centerY);
    ...
    for (int ix = minX; ix < maxX; ix++) {
      for (int iy = minY; iy < maxY; iy++) {
        ...
        if ((selroi != null && selroi.contains(ix, iy)) || (selroi == null && dx * dx + dy * dy < radiusToCut))
