...
// reading instead from a parameter file and starting up fresh
    ...
    if (state == null) // couldn't find a checkpoint argument
    {
      ...
      // by default.
      output.addLog(ec.util.Log.D_STDOUT, Output.V_TOTALLY_SILENT /*V_VERBOSE*/, false);
      output.addLog(ec.util.Log.D_STDERR, Output.V_TOTALLY_SILENT /*V_VERBOSE*/, true);
